...
multitask_model = MultitaskModel.create_model(model_name=model_name,
                                              model_type_dict={
                                                  ...
                                                  "stsb_multi_mt": transformers.AutoModelForMaskedLM
                                              },
                                              model_config_dict={
                                                  "mnli": transformers.AutoConfig.from_pretrained(model_name,num_labels=1),
                                                  "stsb_multi_mt": transformers.AutoConfig.from_pretrained(model_name)
                                              }
                                              )
...
# TODO: Change this after datacollator
#Loading datasets
dataset_dict = {
...
column_dict = {
    ...
    "stsb_multi_mt": ['input_ids', 'attention_mask']
}
